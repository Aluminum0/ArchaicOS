...
Archaic OS is a linux based operating system that uses a brand new (in-progress) package manager.

(Archaic sounds much cooler than Arch)
...
Debian 13 (in form of vm or otherwise)
